...
function setup_lsp()
    ...
    lsp.on_attach(function(client, bufnr)
        ...
        vim.keymap.set("n", lsp_keys.goToNext, function() vim.diagnostic.jump({ count = 1, float = true }) end, opts)
        vim.keymap.set("n", lsp_keys.goToPrev, function() vim.diagnostic.jump({ count = -1, float = true }) end, opts)
